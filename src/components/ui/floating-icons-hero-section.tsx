...
const Icon = ({
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 p-3 rounded-3xl shadow-xl bg-slate-900/80 backdrop-blur-md border border-slate-700/50"
                animate={{
                    y: [0, -8, 0, 8, 0],
                    x: [0, 6, 0, -6, 0],
                    rotate: [0, 5, 0, -5, 0],
            ...
            >
                <iconData.icon className="w-8 h-8 md:w-10 md:h-10 text-white" />
            </motion.div>
        </motion.div>
    );
};
...
>(({ className, icons, ...props }, ref) => {
    ...
    return (
        <div
            ...
            className={cn(
                'absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-20 md:z-0 opacity-25 md:opacity-100',
                className
            )}
            {...props}
        >
...
export const IconApple = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor" className="text-white/80" xmlns="http://www.w3.org/2000/svg">
...
export const IconVercel = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor" className="text-white/90" xmlns="http://www.w3.org/2000/svg">
...
export const demoIcons: IconProps[] = [
